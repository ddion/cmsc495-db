...
// File:     ViewFollowedUpdates.java
// Platform: JDK 7
//           JUnit 4.8.2
//           NetBeans IDE 7.0.1
//           PostgreSQL 9.1
//           Ubuntu 11.10
// Purpose:  Provides a class that represents a SPLATTER_API.VIEW_FOLLOWED_UPDATES
...
/**
 * A prepared call to the SPLATTER_API.VIEW_FOLLOWED_UPDATES function.
 * 
 * @author msongy
 */
public class ViewFollowedUpdates
        extends AbstractViewUpdates {
    
    /**
     * Constructs a <code>ViewFollowedUpdates</code> statement.
     * 
     * @param connection JDBC connection
     * @throws SQLException if there is an error preparing the statement
     */
    public ViewFollowedUpdates(Connection connection)
            throws SQLException {
        super(connection.prepareStatement(
                "select * from SPLATTER_API.VIEW_FOLLOWED_UPDATES(?, ?, ?, ?)"));
    }
